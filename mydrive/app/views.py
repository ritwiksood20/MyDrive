...
def send_email(mail, subject,temp_message):
    ...
    try:
        ...
        mail_server.login(user="facultymanagement2021@gmail.com", password="svvv@123")
        mail_server.sendmail("facultymanagement2021@gmail.com", mail, msg=message.as_string())
        mail_server.quit()
